/////@description drawing health and level bars on screen
//
...
//
////healthbar
//var _health_bar_width = _statbar_width * (hp/hp_max);
//
...
//
////XP
//var _xp_bar_width = _statbar_width * (xp/xp_to_level_up);
...
//draw_text(_dx+_statbar_width/2, _dy+_statbar_height/2, $"LEVEL {level}");
//
////reset properties
