...
//move_and_collide(_hor*move_speed, _ver*move_speed, [layer_tilemap_get_id("Tiles_Walls"), layer_tilemap_get_id("Tiles_Wall_Tops"), obj_enemy_parent]);
move_and_collide(_hor*move_speed, _ver*move_speed, collision_things);
