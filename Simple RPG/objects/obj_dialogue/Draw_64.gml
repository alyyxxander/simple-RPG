...
//===================DRAWING PORTRAIT (trying) (sucess!!)
_dx = _box_width - _box_height + border; 
_dy = (gui_height * 0.7) + border;
var _portrait = global.character_portraits[$ _name];
if (!is_undefined(_portrait)) {
   draw_sprite_stretched(_portrait, 0, _dx, _dy, _box_height-(border*2), _box_height-(border*2)); 
}
